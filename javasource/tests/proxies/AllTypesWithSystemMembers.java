...
public class AllTypesWithSystemMembers
{
	...
	protected AllTypesWithSystemMembers(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject allTypesWithSystemMembersMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf(entityName, allTypesWithSystemMembersMendixObject.getType())) {
	...
	public static java.util.List<tests.proxies.AllTypesWithSystemMembers> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> tests.proxies.AllTypesWithSystemMembers.initialize(context, obj))
	 ...
	 */
	public final java.math.BigDecimal getFloatValue()
	{
	 ...
	 * @return value of FloatValue
	 */
	public final java.math.BigDecimal getFloatValue(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.math.BigDecimal) getMendixObject().getValue(context, MemberNames.FloatValue.toString());
	}
	 ...
	 * @param floatvalue
	 */
	public final void setFloatValue(java.math.BigDecimal floatvalue)
	{
	 ...
	 * @param floatvalue
	 */
	public final void setFloatValue(com.mendix.systemwideinterfaces.core.IContext context, java.math.BigDecimal floatvalue)
	{
	 ...
	 */
	public final java.math.BigDecimal getCurrencyValue()
	{
	 ...
	 * @return value of CurrencyValue
	 */
	public final java.math.BigDecimal getCurrencyValue(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.math.BigDecimal) getMendixObject().getValue(context, MemberNames.CurrencyValue.toString());
	}
	 ...
	 * @param currencyvalue
	 */
	public final void setCurrencyValue(java.math.BigDecimal currencyvalue)
	{
	 ...
	 * @param currencyvalue
	 */
	public final void setCurrencyValue(com.mendix.systemwideinterfaces.core.IContext context, java.math.BigDecimal currencyvalue)
	{
