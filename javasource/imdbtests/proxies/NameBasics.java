...
public class NameBasics
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "ImdbTests.NameBasics"));
	}
	...
	protected NameBasics(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject nameBasicsMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("ImdbTests.NameBasics", nameBasicsMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a ImdbTests.NameBasics");
	...
	{
		java.util.List<imdbtests.proxies.NameBasics> result = new java.util.ArrayList<imdbtests.proxies.NameBasics>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//ImdbTests.NameBasics" + xpathConstraint))
			result.add(imdbtests.proxies.NameBasics.initialize(context, obj));
		return result;
	}
