...
public class Query
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "MxDbUtils.Query"));
	}
	...
	protected Query(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject queryMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("MxDbUtils.Query", queryMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MxDbUtils.Query");
